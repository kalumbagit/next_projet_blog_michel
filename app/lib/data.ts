...
export const profile: Profile = {
  id: "1",
  firstName: "Michel Armand",
  lastName: "MELINGUI NGUEMBA ",
  title: " Gestionnaire & Juriste",
  bio: `Ce site est né d’un geste simple : lire et transmettre.

Je ne cherche ni l’audience rapide, ni le consensus facile. Nous vivons dans un temps pressé, où les mots circulent vite mais s’installent rarement.

 C’est la raison pour laquelle, J’ai voulu créer un lieu qui résiste à cette hâte — un lieu où la pensée prend son temps, où la lecture redevient une expérience intérieure.
Je lis lentement, je n’écris pas pour plaire et je partage par nécessité intérieure.

Ce site est un espace libre : libre de pensée, libre de lecture, libre de temps.
J’y laisse des traces, pour ceux qui viendront, peut-être.

Si ce lieu permet à quelqu’un de ralentir, d’ouvrir un livre, ou d’écouter un texte autrement, alors il aura rempli sa vocation.`,
  formations: [
    "Master en droit",
    "Master en gestion : spécialité gestion des ressources humaines",
    "Spécialiste des métiers de la voix, ",
    "Conseiller Juridique chez ONAMBELE-ANCHANG & ASSOCIATES",
  ],
  motivations: [
...
export const contents: Content[] = [
  ...
  },
  {
    ...
    description:
      "Méditation sur le Mythe de Sisyphe et la réponse camusienne à l'absurdité de l'existence.",
    type: "text",
...
Sisyphe, condamné à rouler éternellement son rocher, devient le héros absurde par excellence. Dans son effort même, dans sa conscience de la futilité, il trouve sa grandeur.`,
  ...
  },
  {
    ...
    description:
      "Réflexion personnelle sur notre rapport au temps dans une société de l'accélération perpétuelle.",
    type: "text",
    category: "reflexions",
...
Méditer, lire lentement, écouter vraiment : autant de pratiques qui nous reconnectent à une temporalité plus humaine.`,
  ...
  },
  {
    ...
    description:
      "Présentation de la théorie de la justice de John Rawls et du voile d'ignorance.",
    type: "audio",
    category: "droit",
    mediaUrl: "/audio-sample.mp3",
    thumbnailUrl: "/placeholder.svg",
    transcription:
      "Imaginez que vous devez concevoir les règles d'une société sans savoir quelle place vous y occuperez. C'est le voile d'ignorance de Rawls. Dans cette position originelle, nous choisirions des principes justes : la liberté pour tous et l'amélioration de la situation des plus défavorisés. Une théorie révolutionnaire de la justice.",
    duration: "28:00",
